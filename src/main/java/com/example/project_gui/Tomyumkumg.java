...
public class Tomyumkumg implements Initializable {
    @FXML
    ...
    ObservableList<Nutrients> list = FXCollections.observableArrayList(
            new Nutrients("CarboHydrate", 26.25),
            new Nutrients("Protein", 80.50),
            new Nutrients("Fat", 2.75)
    );
    ...
    void Select(ActionEvent event){
        ...
        int a = i * 99;
        nameLabel7.setText(String.valueOf(a) + " Baht");
    }
