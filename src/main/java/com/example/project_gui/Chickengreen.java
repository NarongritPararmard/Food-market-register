...
public class Chickengreen implements Initializable {
    @FXML
    ...
    ObservableList<Nutrients> list = FXCollections.observableArrayList(
            new Nutrients("CarboHydrate", 57.60),
            new Nutrients("Protein", 23.00),
            new Nutrients("Fat", 19.60)
    );
    ...
    public void Select(ActionEvent event){
        ...
        int a = i * 65;
        nameLabel5.setText(String.valueOf(a) + " Baht");
    }
