...
public class Hambueger implements Initializable {
    @FXML
    ...
    ObservableList<Nutrients> list = FXCollections.observableArrayList(
            new Nutrients("CarboHydrate", 24.00),
            new Nutrients("Protein", 17.00),
            new Nutrients("Fat", 14.00)
    );
    ...
    void Select(ActionEvent event){
        ...
        int a = i * 79;
        nameLabel6.setText(String.valueOf(a) + " Baht");
    }
