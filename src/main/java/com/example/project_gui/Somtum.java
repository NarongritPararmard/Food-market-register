...
public class Somtum implements Initializable {
    @FXML
    ...
    ObservableList<Nutrients> list = FXCollections.observableArrayList(
            new Nutrients("CarboHydrate", 38.5),
            new Nutrients("Protein", 13.6),
            new Nutrients("Fat", 5.9)
    );
    ...
    void Select(ActionEvent event){
        ...
        int a = i * 50;
        nameLabel2.setText(String.valueOf(a) + " Baht");
    }
