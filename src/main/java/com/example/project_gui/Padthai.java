...
public class Padthai implements Initializable {
    ...
    ObservableList<Nutrients> list = FXCollections.observableArrayList(
            new Nutrients("CarboHydrate", 80.00),
            new Nutrients("Protein", 21.00),
            new Nutrients("Fat", 25.00)
    );
    ...
    void Select(ActionEvent event){
        ...
        int a = i * 89;
        nameLabel.setText(String.valueOf(a) + " Baht");
    }
