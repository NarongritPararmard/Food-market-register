...
public class Springroll implements Initializable {
    @FXML
    ...
    ObservableList<Nutrients> list = FXCollections.observableArrayList(
            new Nutrients("CarboHydrate", 20.00),
            new Nutrients("Protein", 12.20),
            new Nutrients("Fat", 10.00)
    );
    ...
    void Select(ActionEvent event){
        ...
        int a = i * 60;
        nameLabel4.setText(String.valueOf(a) + " Baht");
    }
